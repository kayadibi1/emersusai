...
// Export main so the wrapper (backfill-semantic-scholar.js --direct) can call it.
export { main };

// Auto-run when invoked directly (node scripts/backfill-semantic-scholar-direct.js).
