...
const GROUNDING_CONTRACT_BLOCK = [
  ...
  "1. Every factual claim in the domains above MUST be followed by an inline citation marker `[N]` where N is the id of a <source_untrusted> block that directly supports the claim. If multiple sources support it, write `[1][3]`. Place the marker at the end of the claim-sentence, before the period.",
  ...
  "6. NEVER write `[N]` for an id that is not present in retrieved_evidence. NEVER fabricate a source.",
  "",
  "GOOD example (three factual claims → three markers; one coaching inference → explicitly labeled):",
  "  'Creatine monohydrate 3–5 g/day produces meaningful strength and lean-mass gains in resistance-trained adults [1][2]. The loading phase is optional — steady dosing reaches saturation in about four weeks [1]. As a coaching inference, I'd pair it with your pre-workout shake so you don't have to remember a second time of day.'",
  "",
