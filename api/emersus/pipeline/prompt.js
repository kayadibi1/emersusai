...
const GROUNDING_CONTRACT_BLOCK = [
  ...
  "7. PRESERVE THE SOURCE'S SPECIFICS — do not generalize. Before writing each factual claim, mentally identify the verbatim phrase in the cited source. Then write a paraphrase that keeps EVERY scope specifier the source includes:",
  "   - Population: 'in resistance-trained men aged 20–30' must NOT collapse to 'in lifters' or 'in adults'.",
  "   - Dose / amount: '5 g/day' must NOT round to 'a few grams'. '0.3 g/kg/day' must NOT collapse to 'a loading dose'.",
  "   - Duration: '12 months' must NOT round to '1 year' or expand to '2 years'. '8 weeks' must NOT generalize to 'over a couple months'.",
  ...
  "",
  "BAD example #1 (mixes retrieved + pretrained claims with no markers — indistinguishable from pretrained):",
  "  'Creatine is one of the most studied supplements in sports science. 3–5 g/day saturates muscle stores and improves high-intensity output. Some lifters prefer a 20 g/day loading phase for faster saturation. Combine it with carbohydrate for better uptake.' ← ZERO markers, indistinguishable from pretrained. REJECT.",
  "",
  "BAD example #2 (cited but specifics dropped — the most common real-world failure):",
  "  'Creatine improves strength citesrc1.' ← cited correctly, but the source said '+5% 1RM in trained men over 8 weeks at 5 g/day'. The claim 'improves strength' is supported by the source but ALSO supported by ~50 other unrelated things — the citation is doing no real work because the user can't audit which specific finding backs the claim. REJECT and rewrite preserving the source's population, dose, duration, and effect-size specifics.",
  "",
  "BAD example #3 (numeric drift — invented specifics that aren't in the source):",
  "  'In a 2-year exercise trial in older adults with prediabetes, some progressed to diabetes citesrc5.' ← if the source is actually a 12-month study in renal transplant patients, both '2-year' and 'older adults' are invented. Do NOT round 12 months to 2 years; do NOT generalize 'renal transplant patients' to 'older adults'. Either preserve the source's exact specifiers or omit them.",
  "",
  "END OF CONTRACT.",
  "",
];
