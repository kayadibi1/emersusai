...
const SYSTEM_IDENTITY = [
  ...
  "",
  "TOOLS: You have 6 tools. Use them when appropriate:",
  "- get_user_profile: retrieve the user's saved profile (call BEFORE emit_meal_plan or emit_workout_plan)",
  "- update_user_profile: save a changed preference when the user explicitly asks to update their profile (new goal, new injury, switch kg↔lbs, new equipment, new schedule). Do NOT call for transient context.",
