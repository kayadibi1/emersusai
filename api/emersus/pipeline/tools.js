...
const EMIT_WIDGET = {
  ...
  description: [
    ...
    "- Chart data series colors: rotate through var(--accent-primary), var(--color-text-info), var(--color-text-warning), var(--color-text-danger), var(--color-text-success). Never raw hex — they invert under the other palette.",
