...
const EMIT_MEAL_PLAN = {
  ...
  description: [
    ...
    "",
    "BEFORE calling: check the user_profile for body_weight_kg, height_cm, date_of_birth, biological_sex, activity_level.",
    "If ANY are null/missing, use these defaults and state your assumptions briefly in prose:",
    ...
    "Always call the tool — never respond with only text when the user asks for a meal plan.",
    "",
